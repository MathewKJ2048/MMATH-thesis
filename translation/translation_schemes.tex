...
\begin{enumerate}
	\item There are two schema
	\item The first scheme embeds the command inside Init
	\item The second scheme embeds the command inside an Invariant
	\item The two schemes need separate tooling to interpret SAT/UNSAT and extract instances
\end{enumerate}

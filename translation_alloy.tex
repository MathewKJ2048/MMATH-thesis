...
\begin{itemize}
  ...
  \item This, any instance produced by C is also produced by C'
\end{itemize}
...
(Problem, the algorithm is not rendering)
...
\IF{$state\_queue = []$}
    \STATE exit("No Init states found")
\ENDIF
